    ...
    sections: [
      {
        ...
        items: ["Complete electrical planning", "Safe and certified wiring", "Lighting and socket placements", "Main distribution board installation"],
        icon: <Icons.Zap />
      },
      {
        title: "Solar & Backup Systems",
        items: ["Home solar integration", "Inverter and battery backups", "Load-shedding protection", "Energy-efficient equipment"],
        icon: <Icons.Sun />
      },
      {
        title: "Security & Automation",
        items: ["CCTV camera installation", "Smart security systems", "Automated gates integration", "Motion sensor lighting"],
        icon: <Icons.Shield />
      }
    ],
    whyChooseTitle: "Why Choose Us in Wakiso?",
    whyChoose: ["Comprehensive coverage across Wakiso district", "Affordable and transparent pricing", "Dedicated support and maintenance", "Focus on safety and durability"],
    faqs: [
      { q: "Do you cover all areas of Wakiso?", a: "Yes, our team is equipped to handle electrical projects across Wakiso District." },
      { q: "Can you help with full-house wiring for a new build?", a: "Yes, our certified electricians manage complete electrical installations from planning to final fix." }
    ],
    internalLinks: [
      { text: "Are you building a new home?", linkText: "See our Electrical Installation Services", page: Page.SEO_ELEC_INSTALL },
      { text: "Looking for property security in Wakiso?", linkText: "Explore Smart Security & CCTV", page: Page.SEO_CCTV }
    ],
    cta: "Ready to start your electrical project in Wakiso? Contact Dynawatt Engineering for a site visit today."
  },
  KOLOLO: {
