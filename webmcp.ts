import { defineTool, unregisterAll, jsonContent, textContent } from 'webmcp-kit';
import { z } from 'zod';
...
export const calculateSolarSystem = defineTool({
...
export const navigateToPage = defineTool({
  name: 'navigateToPage',
...
export const submitLeadForm = defineTool({
  name: 'submitLeadForm',
...
export const submitSolarForm = defineTool({
...
// Function to register all tools with WebMCP
...
export function unregisterAllWebMcpTools() {
  try {
    unregisterAll();
